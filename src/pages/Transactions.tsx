...
const Transactions = () => {
    ...
    useEffect(() => {
        ...
        fetchAllTransactionTypeS();
        fetchAllImovel();
    }, [fetchAllTransactions, fetchAllTransactionTypeS, fetchAllImovel]);
    ...
    const openEditTransaction = (t: Transaction) => {
        ...
        setImovelId(t.imovel?.id?.toString() || "");
        setDialogOpen(true);
    };
    ...
    const handleSaveTransaction = async () => {
        ...
        if (!formValor || isNaN(numericValor) || numericValor <= 0) {
            return toast({
                title: "Atenção",
                description: "Informe um valor válido e maior que zero.",
                variant: "destructive"
            });
        }
        ...
        const payload = {
            ...
            imovel: imoveis.find(i => i.id === Number(imovelId)),
        };
    ...
    const filtered = safeTransactions.filter((t) => {
        ...
        if (filterImovel !== "all" && t.imovel?.id?.toString() !== filterImovel) return false;
                    ...
                    <div className="space-y-4 py-2">
                        ...
                        <div className="flex items-center justify-between">
                            ...
                            <div className="flex items-center gap-2">
                                <span
                                    className="text-xs text-muted-foreground">{formIsProfit ? "Receita" : "Despesa"}</span>
